...
import ImagesBoard from "./image.board";
    ...
    <div className="flex flex-col gap-10">
      ...
      >
        <div className="absolute inset-0 opacity-5">
          <div className="w-full h-full bg-gradient-to-br from-primary/20 to-transparent rounded-3xl"></div>
        </div>

        {images.length > 0 && (
          <>
            <div className="lg:hidden abs">
